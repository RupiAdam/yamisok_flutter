...
class PageFilterLokasi extends StatefulWidget {
  @override
  _PageFilterLokasiState createState() => _PageFilterLokasiState();
}

class _PageFilterLokasiState extends State<PageFilterLokasi> {
  ...
  void validateAndSubmit(){
    ...
    setKotaForSearch(varIdCity.toString(), varCity.toString(), varProvince.toString()).then((val) {
  ...
  void initState() {
    ...
    analytics.logEvent(name: 'Filter_lokasi_home');
    fetchDataInit();
