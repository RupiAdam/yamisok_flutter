...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  void initState() {
    ...
    youtubeUrl = '';
    hiddenEmail = false;
    hiddenDateOfBirth = false;
    hiddenPhone = false;
   


    listSkillheaderFirst.clear();
    listSkillheader.clear();
    listSkill.clear();
    apiEndorse();
    ...
    apiProfilelevel();
    print('lihat init profile after api');
  ...
  Widget build(BuildContext context) {
      ...
      child: Center(
        child: Row(
          ...
          children: <Widget>[
            ...
            GestureDetector(
                onTap: () async {
                  var statusdata = await  Navigator.push(
                        context,
    ...
    Widget _dataInformasi(){
      ...
      print('lihat masuk k redux profile');
      //redux
      fullname = '-';
      urlname = '';
      dateofborn = '-';
      ...
      print('lihat detail profile $detailProfile');
      if(detailProfile != '' || detailProfile != null){
        // print("detailProfile");
        // print(detailProfile);
         fullname = detailProfile[0]['real_name'].toString() == 'null' || detailProfile[0]['real_name'].toString() == '' ? '-' : detailProfile[0]['real_name'];
         urlname = detailProfile[0]['url'].toString() ?? '';
         dateofborn = detailProfile[0]['date_of_born'].toString() == 'null' || detailProfile[0]['date_of_born'].toString() == '' ? '-' : detailProfile[0]['date_of_born'];
         genderRedux = detailProfile[0]['gender'].toString() == 'P' ? 'Pria' : 'Wanita';
         phoneNumber = detailProfile[0]['phone_number'].toString() ?? '';
         address = detailProfile[0]['player_address'].toString() == 'null' || detailProfile[0]['player_address'].toString() == '' ? '' : detailProfile[0]['player_address'].toString();
         city = detailProfile[0]['cityName'].toString() == 'null' || detailProfile[0]['cityName'].toString() == '' ? '-' : detailProfile[0]['cityName'];
         provinceName = detailProfile[0]['province_name'].toString() == 'null' || detailProfile[0]['province_name'].toString() == '' ? '-' : detailProfile[0]['province_name'];
         countryName = detailProfile[0]['country_name'].toString() == 'null' || detailProfile[0]['country_name'].toString() == '' ? '-' : detailProfile[0]['country_name'];
         email = detailProfile[0]['email'].toString() ?? '';
         facebookUrl = detailProfile[0]['facebook_url'].toString() == 'null' ? '' : detailProfile[0]['facebook_url'];
         twitterUrl = detailProfile[0]['twitter_url'].toString() == 'null' ? '' : detailProfile[0]['twitter_url'];
         instagramUrl = detailProfile[0]['instagram_url'].toString() == 'null' ? '' : detailProfile[0]['instagram_url'];
         youtubeUrl = detailProfile[0]['youtube_url'].toString() == 'null' ? '' : detailProfile[0]['youtube_url'];
         hiddenEmail = detailProfile[0]['hidden_email'] == 0 ? true : false;
         hiddenDateOfBirth = detailProfile[0]['hidden_date_of_birth'] == 0 ? true : false;
         hiddenPhone = detailProfile[0]['hidden_phone'] == 0 ? true : false;
        return Container(
          decoration: BoxDecoration(
         ...
         print('lihat detail profile on init ');
        var usernameParsedt='';
