...
class ApiServiceAboutMe {
   ...
   final statusCode = response.statusCode;
    print('lihat status code api endorse $statusCode');
    if (statusCode==200) {
