...
class ApiUnEndorse {
    ...
    static Future<String> apiunendorse(skillid,player_id_others) async {
    ...
    var bodyPost = json.encode(data);
     print('lihat body dan parse endore $bodyPost dan $url ');
    if(statusApi==false){
      url="$baseUrl/$urllink/$skillid/unendorse/$userPlayerId";
    }else{
      url="$baseUrlPro/$urllink/$skillid/unendorse/$userPlayerId";
    }
