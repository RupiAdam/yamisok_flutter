...
class ApiPopular {
    static Future<String> apipopular() async {
    ...
    if(statusApi==false){
      url="$baseUrl/$urllink=$playerId&offset=0&limit=10";
    }else{
      url="$baseUrlPro/$urllink=$playerId&offset=0&limit=10";
    }
   ...
   final statusCode = response.statusCode;
    print('lihat status code api list game popular $statusCode');
    if (statusCode==200) {
