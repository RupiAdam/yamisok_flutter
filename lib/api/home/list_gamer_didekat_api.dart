...
class ApiGamerTerdekat {
   ...
   final statusCode = response.statusCode;
    print('lihat status code api gamers terdekat $statusCode');
    if (statusCode==200) {
