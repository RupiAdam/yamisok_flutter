...
class ApiServiceachieveteam {

 static Future<String> apiachieveteam(String idteam) async {
    final bool statusApi = globals.statusApi;
    final String baseUrl = globals.baseUrlApi;
    final String baseUrlPro = globals.urlApiPro;
    var url="$baseUrl/v1/teams/get-team-achievements?id=$idteam";
    ...
    if(statusApi==false){
      url="$baseUrl/v1/teams/get-team-achievements?id=$idteam";
    }else{
      url="$baseUrlPro/v1/teams/get-team-achievements?id=$idteam";
    }
